...
**Livox_handheld** is an open soure project of a handheld device, which is designed for Livox-MID40 LiDAR. All of the modules in this project are capable of [*FDM (Fused Deposition Modeling)*](https://en.wikipedia.org/wiki/Fused_filament_fabrication) printable.  Our project includes all of the source files ([*Solidworks*](https://www.solidworks.com) files, with suffix “\*.SLDPRT; \*.SLDASM”) and commonly 3D (STL) files (under the “release” directory), from which our users can reproduce our works easily.
